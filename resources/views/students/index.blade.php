<x-app-layout>
    <x-slot name="header"><h2 class="font-semibold text-xl text-gray-800 dark:text-white">My Classrooms</h2></x-slot>
    <div class="py-12">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-1 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 dark:text-white">
                        <h2 class="text-lg font-semibold mb-4 dark:text-white">Join a Classroom</h2>
                        ...
                        <form action="{{ route('student.join') }}" method="POST">
                            @csrf
                            <div class="mb-4">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Join Code</label>
                                <input type="text" 
                                       name="join_code" 
                                       maxlength="6" 
                                       ...
                                       required>
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Ask your teacher for the 6-character code</p>
                            </div>
                ...
                <div class="lg:col-span-2 bg-white dark:bg-gray-800 shadow rounded p-6">
                        ...
                        <div class="space-y-2">
                            @foreach(auth()->user()->classrooms as $classroom)
                                <div class="flex items-center justify-between p-3 border border-gray-200 dark:border-gray-700 dark:bg-gray-700 rounded">
                                    <div>
                                        <h3 class="font-semibold dark:text-white">{{ $classroom->name }}</h3>
                                        <p class="text-sm text-gray-600 dark:text-gray-400">{{ $classroom->assignments()->count() }} assignments</p>
                                    </div>
